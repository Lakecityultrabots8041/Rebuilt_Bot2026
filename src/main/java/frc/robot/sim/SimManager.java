...
public class SimManager {
  ...
  public SimManager(RobotContainer robotContainer) {
    ...
    flywheel = new FlywheelSimModel(shooter.getFlywheelMotor(), shooter.getFlywheelMotor2());
    pivotArm = new PivotArmSimModel(intake.getPivotMotor1(), intake.getPivotMotor2());
  }
