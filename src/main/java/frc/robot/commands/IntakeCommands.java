...
public final class IntakeCommands {
  ...
  public static Command autonIntake(IntakeSubsystems intakeSubsystems) {
    return Commands.sequence(intakeSubsystems.intake(), Commands.waitSeconds(10))
  ...
  public static Command pivotToIntake(IntakeSubsystems intakeSubsystems) {
    return Commands.sequence(
        intakeSubsystems.pivotToIntake(), intakeSubsystems.waitUntilPivotAtTarget());
  }
  ...
  public static Command endingIntakeSequence(IntakeSubsystems intakeSubsystems) {
    return Commands.sequence(intakeSubsystems.idle(), intakeSubsystems.pivotToTravel())
