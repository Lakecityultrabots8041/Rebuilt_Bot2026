...
/**
 * Demo-only command: robot follows ANY visible AprilTag at a safe distance. Hold someone walks
 * around with a printed AprilTag and the robot trails them.
 *
 * <p>Bind to a held button (whileTrue) so the robot stops when the button is released. NOT for
 * competition use, demo/outreach only.
 */
public class FollowTag_Demo extends Command {
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber(
        "Demo/Target Distance (in)", Units.metersToInches(TARGET_DISTANCE_METERS));
