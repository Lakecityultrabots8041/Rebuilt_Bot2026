...
/**
 * Vision constants for 2026 REBUILT. All distances in meters unless noted. See vision.md for field
 * layout and tag details.
 */
public final class VisionConstants {
  ...
  static {
    ...
    double hubShootDistance =
        Units.inchesToMeters(
            80); // Measured from center of hub to front of Limelight lens at shooting position
  ...
  public static final Set<Integer> ALL_HUB_TAGS =
  ...
  public static final double VISION_MAX_SPIN =
      Math.toRadians(720); // reject during fast spins (720 deg/s)
